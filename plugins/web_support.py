...
async def get_status():
    ...
    try:
        ...
        total_users = "Database Error 🚨"
        total_premium_users = "Database Error 🚨"
...
RoxyRenameBot = web.RouteTableDef()

@RoxyRenameBot.get("/", allow_head=True)
...
async def web_server():
    ...
    web_app.add_routes(RoxyRenameBot)
    return web_app
